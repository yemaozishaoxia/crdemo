...
public class JwtUtil {
  ...
  @Value(value = "${jwt.encryptkey}")
  public void setHotkey(String hotkey) {
    JwtUtil.hotkey = hotkey;
  }
  ...
  public static String createJWT(User user) {
    ...
    logger.info(user.getUsername() + "生成token时间" + now);
    ...
    if (expire >= 0) {
      ...
      throw new ApiErrorException(ApiMsgEnum.JWTEXPIRETIMENOTCORRECT_EXCEPTION);
    }
  ...
  public static String getParam(String param, String token) {
